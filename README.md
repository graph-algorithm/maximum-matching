...
[![Tests](https://img.shields.io/github/workflow/status/graph-algorithm/maximum-matching/ci:cover?event=push&label=tests)](https://github.com/graph-algorithm/maximum-matching/actions/workflows/ci:cover.yml?query=branch:main)
